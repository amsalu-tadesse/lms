...
;(function ($, window, document, undefined) {    
  ...
  Plugin.prototype = {
    init: function () {
      ...
      this.$mainContainer.append("<div class='form-group'><input type='search' id='user_search' placeholder='&#xF002; Search' style='font-family: Arial;width: 45%' class='form-control'/></div>");
